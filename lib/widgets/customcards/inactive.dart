...
class IncommingOfferInactiveCard extends StatelessWidget {
  const IncommingOfferInactiveCard(
      {Key? key,
      required this.size,
      required this.name,
                ...
                child: Container(
                  ...
                  child: Padding(
                    padding: const EdgeInsets.only(
                        top: 6, left: 10, right: 10, bottom: 10),
                    child: Container(
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              Text(
                                "The offer has been deleted from the system.",
                                style: TextStyle(
