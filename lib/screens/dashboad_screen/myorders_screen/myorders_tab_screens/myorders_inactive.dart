...
class MyOrdersInactive extends StatefulWidget {
  const MyOrdersInactive({Key? key}) : super(key: key);

  @override
  State<MyOrdersInactive> createState() => _MyOrdersInactiveState();
}

class _MyOrdersInactiveState extends State<MyOrdersInactive> {
  @override
                                    ...
                                    child: Align(
                                      ...
                                      child: Container(
                                        padding:
                                            EdgeInsets.symmetric(horizontal: 5),
                                        child: Text(
                                          'you can edit the date and  publish the order again.',
                                          style: TextStyle(
                                            fontWeight: FontWeight.w500,
                                            fontSize: Myfont,
